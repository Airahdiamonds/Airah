	...
	try {
		...
		if (ringStyles.length === 0) {
			const ringStyleSeeds = [
				...
				{ SKU: 'RS-003', name: 'French Pave Halo — 18K White Gold', description: 'French pave halo head on 18K white gold knife-edge.', head_style: 'French Pave Halo',   head_style_price: '480', head_metal: '18K White Gold',  head_metal_price: '650', shank_style: 'Knife Edge Pave',     shank_style_price: '420', shank_metal: '18K White Gold',  shank_metal_price: '700', stock_qty: 6  },
				...
				{ SKU: 'RS-009', name: 'Falling Edge Halo Knife — 18K White Gold', description: 'Falling-edge halo with knife-edge solitaire.', head_style: 'Falling Edge Halo',  head_style_price: '500', head_metal: '18K White Gold',  head_metal_price: '650', shank_style: 'Knife Edge Solitaire',shank_style_price: '260', shank_metal: '18K White Gold',  shank_metal_price: '700', stock_qty: 3  },
				...
				{ SKU: 'RS-014', name: 'Surprise Sapphire Knife Edge Pave — 18K White Gold', description: 'Surprise sapphire head on knife-edge pave band.', head_style: 'Surprise Sapphire', head_style_price: '380', head_metal: '18K White Gold', head_metal_price: '650', shank_style: 'Knife Edge Pave',     shank_style_price: '420', shank_metal: '18K White Gold',  shank_metal_price: '700', stock_qty: 3  },
		...
		if (
			...
			await db.insert(reviewsTable).values([
				...
				},
				{
					...
					ring_style_id: ringStyles[2].ring_style_id,
					rating: 5,
					comment: 'Halo head with knife edge looks incredible.',
					image_URL: [],
				},
				{
					user_id: users[2].user_id,
