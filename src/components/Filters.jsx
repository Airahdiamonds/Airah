      ...
      <div className="w-full max-w-full  space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="w-full">
            ...
            <div className="flex justify-between text-xs mt-1">
              <span>Good</span><span>Very Good</span><span>Ideal</span><span>True Hearts</span>
            </div>
        ...
        <div className="flex justify-end">
          <button
            ...
            className="px-6 py-2 bg-red-100 text-red-600 rounded-lg border border-red-400 text-sm hover:bg-red-200"
          >
            Clear Filters
          </button>
        </div>
